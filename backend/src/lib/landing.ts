export const LANDING_SETTINGS_KEY = 'landing_config_v1';

export type LandingAssetType = 'hero' | 'feature';

export const getDefaultLandingConfig = () => ({
  version: 1 as const,
  links: {
    ...
    comparison: {
      ...
      selfHosted: {
        ...
        bullets: [
          ...
          'Integración con tu red/homelab',
          'Personalización y control máximo',
        ],
      },
      rows: [
    ...
    footer: {
      ...
      groups: [
        ...
        },
        {
          ...
          title: 'CloudBox Labs',
          links: [
            { id: 'footer-labs-about', label: 'Sobre CloudBox Labs', href: '#' },
          ],
        },
      ],
