...
export function validateMimeType(mimeType: string, filename: string): boolean {
  ...
  const mimeMap: Record<string, string[]> = {
    ...
    '.wma': ['audio/x-ms-wma'],
    '.mid': ['audio/midi', 'audio/mid', 'audio/x-midi', 'audio/x-mid', 'application/midi', 'application/x-midi'],
    '.midi': ['audio/midi', 'audio/mid', 'audio/x-midi', 'audio/x-mid', 'application/midi', 'application/x-midi'],
