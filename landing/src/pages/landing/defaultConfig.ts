...
export const FALLBACK_LANDING_CONFIG: LandingConfigV1 = {
  ...
  links: {
    ...
    appUrl: 'https://cloudbox.lat/login',
  ...
  sections: {
    hero: {
      ...
      primaryCta: { label: 'Entrar a CloudBox', href: 'https://cloudbox.lat/login' },
    ...
    useCases: {
      ...
      title: 'Casos de uso',
      items: [
        { id: 'use-family', icon: 'Home', title: 'Familias', description: 'Una nube privada compartida para fotos, documentos y archivos del hogar.' },
        { id: 'use-office', icon: 'Building2', title: 'Pequeñas oficinas', description: 'Gestión de documentos internos y colaboración simple sin depender de terceros.' },
        { id: 'use-creators', icon: 'Video', title: 'Creadores', description: 'Archivos pesados, proyectos y backups en un espacio organizado.' },
        { id: 'use-homelab', icon: 'Cpu', title: 'Homelabs', description: 'Centraliza backups, fotos y vídeos en tu propia infraestructura.' },
      ],
    },
    faq: {
      enabled: true,
      ...
      groups: [
        {
          ...
          title: 'Producto',
          links: [
            { id: 'footer-login', label: 'Entrar a CloudBox', href: 'https://cloudbox.lat/login' },
        ...
        },
        {
          ...
          title: 'Legal',
          links: [
            { id: 'footer-terms', label: 'Términos de servicio', href: 'https://cloudbox.lat/terms' },
            { id: 'footer-privacy', label: 'Política de privacidad', href: 'https://cloudbox.lat/privacy' },
          ],
        },
      ],
