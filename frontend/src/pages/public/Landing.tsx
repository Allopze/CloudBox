...
import {
  ...
  ToastProvider,
  ChapterSection
} from './landing/LandingEnhancements';
    ...
    <ToastProvider>
      <div className="bg-dark-50 dark:bg-dark-900 min-h-screen text-dark-600 dark:text-dark-400 transition-colors duration-300 selection:bg-[#F44336]/30 selection:text-[#F44336]">
        ...
        <main className="pt-36 pb-20">
              ...
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-4 flex flex-col items-start text-left">
                  ...
                  <div className="flex flex-wrap gap-4 mb-8 w-full">
                    <InteractiveButton href={hero.primaryCta.href}>
                  ...
                  <div className="mb-12">
                    <CopyLinkButton link="cloudbox.lat/s/demo-x7k2" />
                  </div>
                ...
                <div className="lg:col-span-8 relative w-full">
                  <div className="relative aspect-[16/10] max-h-[650px]">
                    ...
                    {config.assets?.heroImageUrl ? (
                      ...
                      <LayeredHeroMockup isDark={isDark} />
                    )}
                  </div>
                </div>
              </div>
          ...
          {/* Scroll Chapters - Storytelling Section */}
          <ChapterSection isDark={isDark} />
